...
JARVIS uses the **Brave Search API** to search the web. This skill is loaded by the gateway from `skills/web-search/` so JARVIS can answer current-events and real-time questions instead of saying he doesn't have access.
...
See [docs/BRAVE_SEARCH_SETUP.md](../../docs/BRAVE_SEARCH_SETUP.md) for more options (Vault, `clawdbot configure --section web`).
